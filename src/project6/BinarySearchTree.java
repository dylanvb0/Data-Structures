...
public class BinarySearchTree<E> 
{
    ...
    // same as remove method except it returns the object that was removed
    // and null if the object didn't exist per assignment requirement
    public E removeObj (E obj) {
    	return (remove(obj)) ? obj : null;
    }
    ...
    // find method that returns the item if it is found
    public E find(E x) {
    	return (getEntry(x) != null) ? x : null;
    }
